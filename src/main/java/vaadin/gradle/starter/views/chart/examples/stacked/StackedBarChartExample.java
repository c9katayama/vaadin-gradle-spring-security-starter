package vaadin.gradle.starter.views.chart.examples.stacked;
...
public class StackedBarChartExample extends ApexChartsBuilder {
	...
	public StackedBarChartExample() {
		...
		withChart(ChartBuilder.get().withType(Type.BAR).withStacked(true).build())
				...
				.withXaxis(XAxisBuilder.get()
						.withCategories("Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct").build())
